...
def main() -> None:
    st.set_page_config(page_title="RAG Movies", layout="wide")
    st.title("🎬 RAG: Поиск по фильмам")
    st.caption("Учебный RAG на Wikipedia Movie Plots: TF-IDF + demo-ответ с источниками")
